...
void main () {
    ...
    assert (declassify (au8 + bu8) == (42 :: uint8));
    assert (declassify (au16 + bu16) == (42 :: uint16));
    assert (declassify (au32 + bu32) == (42 :: uint32));
    assert (declassify (au64 + bu64) == (42 :: uint64));
    assert (all (declassify (xu8 + yu8) == (42 :: uint8)));
    assert (all (declassify (xu16 + yu16) == (42 :: uint16)));
    assert (all (declassify (xu32 + yu32) == (42 :: uint32)));
    assert (all (declassify (xu64 + yu64) == (42 :: uint64)));
}
